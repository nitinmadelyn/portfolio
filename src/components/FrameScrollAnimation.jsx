...
const FrameScrollAnimation = ({ frameCount = 240 }) => {
  ...
  return (
    <div ref={containerRef} className="relative h-[600vh] bg-[#020202]">
      <div className="sticky top-0 left-0 w-full h-[100dvh] overflow-hidden flex items-center justify-center perspective-2000">
      ...
      <motion.div 
        style={{ opacity: useTransform(smoothProgress, [0.3, 0.45, 0.65, 0.8], [0, 1, 1, 0]) }}
