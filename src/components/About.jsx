...
const AwsIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false">
...
export default function About() {
  const Aboutdata = [
    {
      icon: <FiCode size={20} aria-hidden="true" />,
      title: 'Languages',
    ...
    {
      icon: <FiBookOpen size={20} aria-hidden="true" />,
      title: 'Education',
      desc: 'Master in Computer Science',
    },
    {
      icon: <FiAward size={20} aria-hidden="true" />,
      title: 'Projects',
  ...
  const Tools = [
    { icon: <SiNextdotjs size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "Next.js" },
    { icon: <SiReact size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "React.js / React Native" },
    { icon: <SiNodedotjs size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "Node.js" },
    { icon: <SiTypescript size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "TypeScript" },
    { icon: <SiNestjs size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "NestJS" },
    { icon: <SiJavascript size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "JavaScript" },
    { icon: <SiTailwindcss size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "Tailwind CSS" },
    { icon: <SiMongodb size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "MongoDB" },
    { icon: <SiPostgresql size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "SQL / NoSQL" },
    { icon: <SiElasticsearch size={24} aria-hidden="true" role="presentation" focusable="false" />, title: "ElasticSearch" },
