        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center h-12">
          ...
          <div className="flex items-center space-x-4 group cursor-pointer" onClick={() => (window.location.href = '#')}>
            <div className="flex flex-col">
                <span className="text-white text-xl font-black tracking-[0.2em] uppercase leading-none">
                    NITIN<span className="text-blue-500 animate-pulse ml-0.5">.</span>
                </span>
                <span className="text-[8px] font-mono text-blue-600 mt-1 opacity-60 tracking-[0.3em] uppercase">FULL STACK ENGINEER</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <div className="flex items-center space-x-6 border-l border-white/10 pl-10 h-6">
                {/* Hire Me Button */}
                <button className="px-5 py-1.5 bg-blue-600 border border-blue-500 text-white font-mono text-[9px] uppercase tracking-[0.3em] hover:bg-blue-500 transition-all duration-300 rounded-sm shadow-[0_0_15px_rgba(59,130,246,0.4)]">
                    Hire Me
                </button>
            </div>
          </div>
      ...
      >
        ...
        <ul className="relative z-10 flex flex-col space-y-10 text-center">
          ...
          <li className={`pt-6 transition-all duration-500 ${isMobileMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: `${navLinks.length * 100}ms` }}>
            <a href="#contactme" onClick={() => setIsMobileMenuOpen(false)} className="px-12 py-3 bg-blue-600 border border-blue-500 text-white font-mono text-[10px] uppercase tracking-[0.4em] hover:bg-blue-500 transition-all rounded-sm shadow-[0_0_15px_rgba(59,130,246,0.4)] block text-center">
                Hire Me
            </a>
          </li>
        </ul>
