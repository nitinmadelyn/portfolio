...
export default function Hero() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-[100dvh] bg-[#020202] overflow-hidden flex items-center justify-center font-sans tracking-wide">
        ...
        {/* --- HUD ELEMENTS --- */}
        <div className="portfolio-ui absolute top-28 left-8 md:top-32 md:left-12 z-[60] font-mono text-[10px] text-blue-600 tracking-widest flex flex-col space-y-1.5 pointer-events-none">
            <span className="hud-element opacity-0">&gt; AVAILABLE FOR NEW PROJECTS</span>
            <span className="hud-element opacity-0">&gt; 15+ YRS EXPERIENCE</span>
            <span className="hud-element opacity-0">&gt; REMOTE WORLDWIDE</span>
        </div>
        <div className="portfolio-ui absolute bottom-12 right-8 md:bottom-12 md:right-12 z-[60] font-mono text-[10px] text-gray-600 tracking-widest text-right flex-col space-y-1.5 pointer-events-none hidden md:flex">
            <span className="hud-element opacity-0">STACK: REACT · NODE · AWS</span>
            <span className="hud-element opacity-0">UPWORK: 100% SUCCESS · 81+ JOBS</span>
        </div>
